...
public class PlayerInfoRequest extends APIRequest<PlayerInfoCallback> {
	...
	public PlayerInfoRequest(MineBans plugin, int timeout, String issuedBy, String issuedByUUID, String playerName){
	...
	public PlayerInfoRequest(MineBans plugin, String issuedBy, String issuedByUUID, String playerName){
