...
import com.minebans.util.PluginConfigKey;
...
public enum MineBansConfig implements PluginConfigKey {
	...
	MAX_BANS_TOTAL_TOTAL(				"max-bans.total.total",					15),
	MAX_BANS_TOTAL_CONFIRMED(			"max-bans.total.confirmed",				-1),
	MAX_BANS_TOTAL_UNCONFIRMED(			"max-bans.total.unconfirmed",			-1),
	MAX_BANS_TOTAL_LOW(					"max-bans.total.low",					-1),
	MAX_BANS_TOTAL_MEDIUM(				"max-bans.total.medium",				5),
	MAX_BANS_TOTAL_HIGH(				"max-bans.total.high",					5),
	
	MAX_BANS_THEFT_ENABLED(				"max-bans.theft.enabled",				true),
	MAX_BANS_THEFT_TOTAL(				"max-bans.theft.total",					15),
	MAX_BANS_THEFT_CONFIRMED(			"max-bans.theft.confirmed",				-1),
	MAX_BANS_THEFT_UNCONFIRMED(			"max-bans.theft.unconfirmed",			-1),
	MAX_BANS_THEFT_LOW(					"max-bans.theft.low",					-1),
	MAX_BANS_THEFT_MEDIUM(				"max-bans.theft.medium",				5),
	MAX_BANS_THEFT_HIGH(				"max-bans.theft.high",					5),
	
	MAX_BANS_GRIEF_ENABLED(				"max-bans.grief.enabled",				true),
	MAX_BANS_GRIEF_TOTAL(				"max-bans.grief.total",					15),
	MAX_BANS_GRIEF_CONFIRMED(			"max-bans.grief.confirmed",				-1),
	MAX_BANS_GRIEF_UNCONFIRMED(			"max-bans.grief.unconfirmed",			-1),
	MAX_BANS_GRIEF_LOW(					"max-bans.grief.low",					-1),
	MAX_BANS_GRIEF_MEDIUM(				"max-bans.grief.medium",				5),
	MAX_BANS_GRIEF_HIGH(				"max-bans.grief.high",					5),
	
	MAX_BANS_XRAY_ENABLED(				"max-bans.x-ray.enabled",				true),
	MAX_BANS_XRAY_TOTAL(				"max-bans.x-ray.total",					15),
	MAX_BANS_XRAY_CONFIRMED(			"max-bans.x-ray.confirmed",				-1),
	MAX_BANS_XRAY_UNCONFIRMED(			"max-bans.x-ray.unconfirmed",			-1),
	MAX_BANS_XRAY_LOW(					"max-bans.x-ray.low",					-1),
	MAX_BANS_XRAY_MEDIUM(				"max-bans.x-ray.medium",				5),
	MAX_BANS_XRAY_HIGH(					"max-bans.x-ray.high",					5),
	
	MAX_BANS_ABUSE_ENABLED(				"max-bans.abuse.enabled",				false),
	MAX_BANS_ABUSE_TOTAL(				"max-bans.abuse.total",					-1),
	MAX_BANS_ABUSE_CONFIRMED(			"max-bans.abuse.confirmed",				10),
	MAX_BANS_ABUSE_UNCONFIRMED(			"max-bans.abuse.unconfirmed",			-1),
	
	MAX_BANS_ADVERTISING_ENABLED(		"max-bans.advertising.enabled",			false),
	MAX_BANS_ADVERTISING_TOTAL(			"max-bans.advertising.total",			-1),
	MAX_BANS_ADVERTISING_CONFIRMED(		"max-bans.advertising.confirmed",		10),
	MAX_BANS_ADVERTISING_UNCONFIRMED(	"max-bans.advertising.unconfirmed",		-1),
	
	MAX_BANS_FLY_ENABLED(				"max-bans.fly.enabled",					true),
	MAX_BANS_FLY_TOTAL(					"max-bans.fly.total",					-1),
	MAX_BANS_FLY_CONFIRMED(				"max-bans.fly.confirmed",				10),
	MAX_BANS_FLY_UNCONFIRMED(			"max-bans.fly.unconfirmed",				-1),
	
	MAX_BANS_MOVE_SPEED_ENABLED(		"max-bans.movement-speed.enabled",		true),
	MAX_BANS_MOVE_SPEED_TOTAL(			"max-bans.movement-speed.total",		-1),
	MAX_BANS_MOVE_SPEED_CONFIRMED(		"max-bans.movement-speed.confirmed",	10),
	MAX_BANS_MOVE_SPEED_UNCONFIRMED(	"max-bans.movement-speed.unconfirmed",	-1),
	
	MAX_BANS_BLOCK_REACH_ENABLED(		"max-bans.block-reach.enabled",			true),
	MAX_BANS_BLOCK_REACH_TOTAL(			"max-bans.block-reach.total",			-1),
	MAX_BANS_BLOCK_REACH_CONFIRMED(		"max-bans.block-reach.confirmed",		10),
	MAX_BANS_BLOCK_REACH_UNCONFIRMED(	"max-bans.block-reach.unconfirmed",		-1),
	
	MAX_BANS_NOFALL_ENABLED(			"max-bans.nofall.enabled",				true),
	MAX_BANS_NOFALL_TOTAL(				"max-bans.nofall.total",				-1),
	MAX_BANS_NOFALL_CONFIRMED(			"max-bans.nofall.confirmed",			10),
	MAX_BANS_NOFALL_UNCONFIRMED(		"max-bans.nofall.unconfirmed",			-1),
	
	MAX_BANS_NOSWING_ENABLED(			"max-bans.noswing.enabled",				false),
	MAX_BANS_NOSWING_TOTAL(				"max-bans.noswing.total",				-1),
	MAX_BANS_NOSWING_CONFIRMED(			"max-bans.noswing.confirmed",			10),
	MAX_BANS_NOSWING_UNCONFIRMED(		"max-bans.noswing.unconfirmed",			-1),
	
	MAX_BANS_PVP_CHEATS_ENABLED(		"max-bans.pvp-cheats.enabled",			false),
	MAX_BANS_PVP_CHEATS_TOTAL(			"max-bans.pvp-cheats.total",			-1),
	MAX_BANS_PVP_CHEATS_CONFIRMED(		"max-bans.pvp-cheats.confirmed",		10),
	MAX_BANS_PVP_CHEATS_UNCONFIRMED(	"max-bans.pvp-cheats.unconfirmed",		-1),
	
	MAX_BANS_CHAT_SPAM_ENABLED(			"max-bans.chat-spam.enabled",			true),
	MAX_BANS_CHAT_SPAM_TOTAL(			"max-bans.chat-spam.total",				-1),
	MAX_BANS_CHAT_SPAM_CONFIRMED(		"max-bans.chat-spam.confirmed",			10),
	MAX_BANS_CHAT_SPAM_UNCONFIRMED(		"max-bans.chat-spam.unconfirmed",		-1),
	
	MAX_BANS_ITEM_DROP_ENABLED(			"max-bans.item-drop.enabled",			true),
	MAX_BANS_ITEM_DROP_TOTAL(			"max-bans.item-drop.total",				-1),
	MAX_BANS_ITEM_DROP_CONFIRMED(		"max-bans.item-drop.confirmed",			10),
	MAX_BANS_ITEM_DROP_UNCONFIRMED(		"max-bans.item-drop.unconfirmed",		-1);
